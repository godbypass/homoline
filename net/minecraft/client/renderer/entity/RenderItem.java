...
public class RenderItem implements IResourceManagerReloadListener {
    ...
    private int effectColor() {
        if (Novoline.getInstance().getModuleManager().getModule(GlintColorize.class).isEnabled()) {
            GlintColorize glintColorize = Novoline.getInstance().getModuleManager().getModule(GlintColorize.class);
            return glintColorize.glintColor();
        } else {
            return -8372020;
        }
    }
    ...
    private void renderEffect(IBakedModel model) {
        if (!Config.isCustomItems() || CustomItems.isUseGlint()) {
            if (!Config.isShaders() || !Shaders.isShadowPass) {
                ...
                this.renderModel(model, effectColor());
                GlStateManager.popMatrix();
                GlStateManager.pushMatrix();
                GlStateManager.scale(8.0F, 8.0F, 8.0F);
    ...
    protected void renderItemModelTransform(ItemStack stack, IBakedModel model, ItemCameraTransforms.TransformType cameraTransformType) {
        ...
        if (cameraTransformType == ItemCameraTransforms.TransformType.THIRD_PERSON
            ...
            EntityPlayer p = (EntityPlayer) lastEntityToRenderFor; // 👈 cast manually
            ...
            if (heldStack != null) {
                ...
                if (lastEntityToRenderFor == player) {
                    if (heldStack.getItem() instanceof ItemSword
                            && (Novoline.getInstance().getModuleManager().getModule(KillAura.class).shouldBlock()
    ...
    private void func_181565_a(WorldRenderer p_181565_1_, int p_181565_2_, int p_181565_3_, int p_181565_4_, int p_181565_5_, int p_181565_6_, int p_181565_7_, int p_181565_8_, int p_181565_9_) {
        ...
        p_181565_1_.pos(p_181565_2_, p_181565_3_, 0.0D).color(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).endVertex();
        p_181565_1_.pos(p_181565_2_, p_181565_3_ + p_181565_5_, 0.0D).color(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).endVertex();
        ...
        p_181565_1_.pos(p_181565_2_ + p_181565_4_, p_181565_3_, 0.0D).color(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).endVertex();
